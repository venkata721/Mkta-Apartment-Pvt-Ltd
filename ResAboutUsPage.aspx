<%@ Page Title="About Us Page" Language="C#" MasterPageFile="~/ResidentProfileMasterPage.master" AutoEventWireup="true" CodeFile="ResAboutUsPage.aspx.cs" Inherits="ResAboutUsPage" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                  <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/LogOutPage.aspx" style="float:right; position:relative;top:-45px;  margin-bottom:-30px;  font-size:x-large; font-weight:bold; font-family:Garamond; left: 0px; height: 30px; width: 122px;" CssClass="links" BackColor="Black">Log Out</asp:HyperLink>
